...
export class ScoreResolverBase {
  ...
  async createScore(@graphql.Args() args: CreateScoreArgs): Promise<Score> {
    return await this.service.createScore({
      ...
      data: {
        ...
        testTaker: args.data.testTaker
          ? {
              connect: args.data.testTaker,
            }
          : undefined,
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => TestTaker, {
    nullable: true,
    name: "testTaker",
  })
  @nestAccessControl.UseRoles({
  ...
  async getTestTaker(
    ...
    const result = await this.service.getTestTaker(parent.id);
  ...
  async getTest(@graphql.Parent() parent: Score): Promise<Test | null> {
